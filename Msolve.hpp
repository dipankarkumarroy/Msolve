            ...
            else
            {
                if (s[i] == 'f')
                {
                    ...
                    do
                    {
                        ...
                        if (s[i] == ',')
                        {
                            tempstr2 = tempstr2 + _Dip_InfTPo_(tempstr3);
                            tempstr3 = "";
                        }
                        else
                        {
                            ...
                            if (s[i] == 'f')
                            {
                                ...
                                do
                                {
                                    ...
                                    if (s[i] == ',')
                                    {
                                        temps2 = temps2 + _Dip_InfTPo_(temps3);
                                        temps3 = "";
                                    }
                                    else
                                    {
                                ...
                                tempstr2 = tempstr2 + temps2 + _Dip_InfTPo_(temps3) + temps + ' ';
                            }
                            else{tempstr3 = tempstr3 + s[i];}
                    ...
                    postfix = postfix + tempstr2 + _Dip_InfTPo_(tempstr3) + tempstr + ' ';
                    goto label1;
                }
